...
const SUPERADMIN_MENU: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { href: "/dashboard/superadmin/akademik/jenjang", label: "Jenjang", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/departments", label: "Jurusan", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/akademik/fase-tingkat", label: "Fase/Tingkat", roles: ["PLATFORM_ADMIN"] },
      ...
      { href: "/dashboard/superadmin/akademik/kalender-template", label: "Kalender Template", roles: ["PLATFORM_ADMIN"] },
  ...
  },
  {
    ...
    subItems: [
      ...
      { href: "/dashboard/superadmin/penilaian/predikat-nilai", label: "Predikat Nilai", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/penilaian/jenis-penilaian", label: "Jenis Penilaian", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/penilaian/kkm", label: "KKM/Ketuntasan", roles: ["PLATFORM_ADMIN"] },
  ...
  },
  {
    ...
    subItems: [
      ...
      { href: "/dashboard/superadmin/siswa/prestasi", label: "Prestasi", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/siswa/pelanggaran", label: "Pelanggaran", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/siswa/tata-tertib", label: "Tata Tertib", roles: ["PLATFORM_ADMIN"] },
  ...
  },
  {
    ...
    subItems: [
      ...
      { href: "/dashboard/superadmin/administrasi/permission", label: "Permission Management", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/administrasi/master-sdm", label: "Master SDM", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/administrasi/jabatan", label: "Master Jabatan", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/administrasi/subrole", label: "Subrole Management", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/administrasi/dokumen-template", label: "Master Dokumen (Template)", roles: ["PLATFORM_ADMIN"] },
  ...
  },
  {
    ...
    icon: "Wallet",
    subItems: [
      { href: "/dashboard/superadmin/keuangan/jenis-biaya", label: "Jenis Biaya", roles: ["PLATFORM_ADMIN"] },
      ...
      { href: "/dashboard/superadmin/keuangan/tunggakan", label: "Monitoring Tunggakan", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/keuangan/diskon-beasiswa", label: "Diskon/Beasiswa", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/keuangan/payment-settings", label: "Payment Settings", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/keuangan/rekap-pemasukan", label: "Rekap Pemasukan Unit", roles: ["PLATFORM_ADMIN"] },
    ],
  },
  {
    ...
    subItems: [
      ...
      { href: "/dashboard/superadmin/komunikasi/template-notifikasi", label: "Template Notifikasi", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/komunikasi/gateway", label: "Email/WhatsApp Gateway", roles: ["PLATFORM_ADMIN"] },
  ...
  },
  {
    ...
    subItems: [
      ...
      { href: "/dashboard/superadmin/laporan/siswa", label: "Laporan Siswa", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/laporan/guru-staff", label: "Laporan Guru & Staff", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/laporan/penilaian", label: "Laporan Penilaian", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/laporan/keuangan", label: "Laporan Keuangan", roles: ["PLATFORM_ADMIN"] },
      ...
      { href: "/dashboard/superadmin/laporan/executive", label: "Executive Analytics", roles: ["PLATFORM_ADMIN"] },
    ],
  },
  {
    ...
    subItems: [
      ...
      { href: "/dashboard/superadmin/pengaturan/umum", label: "Pengaturan Umum", roles: ["PLATFORM_ADMIN"] },
      ...
      { href: "/dashboard/superadmin/pengaturan/konfigurasi-menu", label: "Konfigurasi Menu", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/pengaturan/feature-toggle", label: "Feature Toggle", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/pengaturan/api-webhook", label: "API & Webhook", roles: ["PLATFORM_ADMIN"] },
      { href: "/dashboard/superadmin/pengaturan/error-monitoring", label: "Error Monitoring", roles: ["PLATFORM_ADMIN"] },
